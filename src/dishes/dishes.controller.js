...
function read(req, res, next) {
  ...
  if (foundDish) {
    res.locals.orderData = { foundDish };
...
function update(req, res) {
  ...
  res.locals.orderData = { id, name, description, image_url, price };
  res.json({ data: foundDish });
}
...
function hasData(req, res, next) {
  ...
  if (name && description && image_url && price) {
    res.locals.orderData = { name, description, image_url, price };
    return next();
  }
...
function create(req, res) {
  ...
  dishes.push(newDish);
  res.locals.orderData = { id, name, description, price, image_url };
